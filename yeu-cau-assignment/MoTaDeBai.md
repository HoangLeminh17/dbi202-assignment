...
- Phần data dictionary và mô hình ER/quan hệ đã có tại [`erd-dictionary/ERD.md`](../erd-dictionary/ERD.md) và [`erd-dictionary/DataDictionary.md`](../erd-dictionary/DataDictionary.md) — copy/đối chiếu nội dung này vào báo cáo [`slide-report/Report.docx`](../slide-report/Report.docx).
